...
namespace SoundTest
{
    public class ImprovedVBE
    {
        ...
        [ManifestResourceStream(ResourceName = "CosmosKernel2.canvas.bmp")] public static byte[] Canvas;
        [ManifestResourceStream(ResourceName = "CosmosKernel2.canvas.bmp")] public static byte[] Canvas2;
